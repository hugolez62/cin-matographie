    ...
    var v = document.getElementById("ville").value;
      ...
      $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById("img").innerHTML = "<img src='https://image.tmdb.org/t/p/w500/"+data.results[0].poster_path +"'/>";
  ...
  $.ajax({
    ...
    success: function (data) {
        ...
        //AFFICHAGE DES 6 FILMS
              var z;
              for(z=0;z<7;z++){
                  $("#lien"+(z+1).toString()).attr("href", "film.php?id="+data.results[z].id);
                  document.getElementById("img"+((z+1).toString())).innerHTML = "<img src='https://image.tmdb.org/t/p/w500/"+data.results[z].poster_path +"'/>";
...
function ajout_recent() {
  $.ajax({
    ...
    dataType: "json",
    url: "https://api.themoviedb.org/3/discover/movie?primary_release_year=2017&sort_by=vote_average.desc&api_key=84298ce1f4116edf6c28f5353209f4a4",
    jsonpCallback: "callback",
    ...
    success: function (data) {
        ...
        //FILM 1
            $("#lien_recent1").attr("href", "film.php?id="+data.results[0].id);
            document.getElementById("imgajoutrecent1").innerHTML = "<img src='https://image.tmdb.org/t/p/w500/"+data.results[0].poster_path +"'/>";
      ...
      //FILM 2
            $("#lien_recent2").attr("href", "film.php?id="+data.results[1].id);
            document.getElementById("imgajoutrecent2").innerHTML = "<img src='https://image.tmdb.org/t/p/w500/"+data.results[1].poster_path +"'/>";
      ...
      //FILM 3
            $("#lien_recent3").attr("href", "film.php?id="+data.results[2].id);
            document.getElementById("imgajoutrecent3").innerHTML = "<img src='https://image.tmdb.org/t/p/w500/"+data.results[2].poster_path +"'/>";
